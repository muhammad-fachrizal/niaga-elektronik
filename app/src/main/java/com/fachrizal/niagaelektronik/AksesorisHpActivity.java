...
public class AksesorisHpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aksesoris_hp);
        ...
        textSelengkapnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AksesorisHpActivity.this, DeskripsiLengkapActivity.class);
        ...
        buttonBeliLangsung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AksesorisHpActivity.this, BeliLangsungActivity.class);
                startActivity(intent);
            }
        });
        ...
        buttonKeranjang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AksesorisHpActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
