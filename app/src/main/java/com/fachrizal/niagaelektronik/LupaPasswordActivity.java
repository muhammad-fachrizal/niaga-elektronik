...
public class LupaPasswordActivity extends AppCompatActivity {
    ...
    public class SendMail extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            props.put("mail.smtp.host", "input host");
            props.put("mail.smtp.socketFactory.port", "input port");
            props.put("mail.smtp.socketFactory.class", "input class");
            props.put("mail.smtp.auth", "input auth");
            props.put("mail.smtp.port", "input port");
            ...
            try {
                ...
                mm.setFrom(new InternetAddress("input email here"));
