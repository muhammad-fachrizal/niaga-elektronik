...
public class PokemonMetagrossActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pokemon_metagross);
        ...
        textSelengkapnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PokemonMetagrossActivity.this, DeskripsiLengkapActivity.class);
        ...
        buttonBeliLangsung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PokemonMetagrossActivity.this, BeliLangsungActivity.class);
                startActivity(intent);
            }
        });
        ...
        buttonKeranjang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PokemonMetagrossActivity.this, MainActivity.class);
                startActivity(intent);
